...
const SettingsPage: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    name: "",
    price: "",
    image: "", // keep internally to preserve existing image on edit
    category: "",
  ...
  const openEditModal = (product: any) => {
    ...
    setFormData({
      ...
      image: product.image, // preserve existing image, no UI to change
  ...
  const validateForm = () => {
    ...
    // ✅ STOCK OPTIONAL: validate only if user fills it
  ...
  const handleSubmit = () => {
    ...
    const productData = {
      ...
      image: formData.image, // '' for new product, preserved for edit
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      {/* Add/Edit Modal (NO IMAGE INPUT/PREVIEW) */}
      <Modal
        isOpen={isModalOpen}
        onClose={closeModal}
