...
const Header: React.FC = () => {
  ...
  // If not logged in, show simple header only (logo + optional clock)
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-3">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Cart shortcut only when logged in and not already in POS */}
            ...
            {isLoggedIn && (
              <div className="relative">
                ...
                {isProfileMenuOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 z-10 border dark:border-gray-700">
